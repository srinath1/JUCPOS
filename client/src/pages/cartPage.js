...
function CartPage() {
  ...
  const onFinish = (values) => {
      ...
      console.log('values',values,cartItems)
      console.log('reqObject=>',localStorage.getItem("pos-user"))
    ...
    const reqObject = {
      ...
      userId: localStorage.getItem("pos-user")._id,
    };
    console.log('reqObject=>',JSON.parse(localStorage.getItem("pos-user"))._id)

    console.log('newreqobject=>',localStorage.getItem('pos-user'))
